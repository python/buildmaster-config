...
def get_builders(settings):
    ...
    return [
        ...
        ("AMD64 Fedora NoGIL", "itamaro-fedora-x1", UnixNoGilBuild, UNSTABLE, NO_TIER),
        ...
        ("x86 Debian Non-Debug with X", "ware-debian-x86", NonDebugUnixBuild, UNSTABLE, NO_TIER),
        ("x86 Debian Installed with X", "ware-debian-x86", UnixInstalledBuild, UNSTABLE, NO_TIER),
        # Linux PPC64le
