...
def get_builders(settings):
    ...
    return [
        ...
        ("PPC64 Fedora", "edelsohn-fedora-ppc64", FedoraBuild, STABLE),
        ("s390x SLES", "edelsohn-sles-z", UnixBuild, STABLE),
        ("s390x Debian", "edelsohn-debian-z", UnixBuild, STABLE),
        ("s390x Fedora", "edelsohn-fedora-z", FedoraBuild, STABLE),
        ...
        ("AMD64 Fedora Stable", "cstratak-fedora-stable-x86_64", FedoraBuild, STABLE),
        ...
        ("AMD64 RHEL7", "cstratak-RHEL7-x86_64", FedoraBuild, STABLE),
        ...
        ("AMD64 RHEL8", "cstratak-RHEL8-x86_64", FedoraBuild, STABLE),
        ...
        # Linux PPC64le
        ("PPC64LE Fedora Stable", "cstratak-fedora-stable-ppc64le", FedoraBuild, STABLE),
        ...
        ("PPC64LE RHEL7", "cstratak-RHEL7-ppc64le", FedoraBuild, STABLE),
        ...
        ("PPC64LE RHEL8", "cstratak-RHEL8-ppc64le", FedoraBuild, STABLE),
        ...
        # Linux aarch64
        ("aarch64 Fedora Stable", "cstratak-fedora-stable-aarch64", FedoraBuild, STABLE),
        ("aarch64 RHEL8", "cstratak-RHEL8-aarch64", FedoraBuild, STABLE),
        # macOS
        ...
        ("AMD64 Fedora Rawhide", "cstratak-fedora-rawhide-x86_64", FedoraBuild, UNSTABLE),
        ...
        # Linux PPC64le
        ("PPC64LE Fedora Rawhide", "cstratak-fedora-rawhide-ppc64le", FedoraBuild, UNSTABLE),
        ...
        # Linux aarch64
        ("aarch64 Fedora Rawhide", "cstratak-fedora-rawhide-aarch64", FedoraBuild, UNSTABLE),
        ...
        # Linux other archs
        ("s390x Fedora Rawhide", "edelsohn-fedora-rawhide-z", FedoraBuild, UNSTABLE),
